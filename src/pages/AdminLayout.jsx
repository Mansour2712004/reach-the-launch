  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="flex flex-wrap gap-2 mb-8 border-b border-white/5 pb-4">
        <NavLink to="/admin" end className={tabClass}>Launches</NavLink>
        <NavLink to="/admin/launches/new" className={tabClass}>Add Launch</NavLink>
        <NavLink to="/admin/developers" className={tabClass}>Developers</NavLink>
        <NavLink to="/admin/submissions" className={tabClass}>Contact Submissions</NavLink>

...
export default function Login() {
  ...
  // Handles the mobile flow: the browser leaves for Google and comes back
  // to this same page already signed in — pick that up and move on.
  useEffect(() => {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="text-xs text-mist">or use your email</span>
        <div className="h-px flex-1 bg-white/10" />
      </div>
